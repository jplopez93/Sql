...
select 'Consulta 1';
select nombre from bicicletas union select nom_fab from motocicletas_electricas order by nombre;
select'Consulta 2';
select nombre,precio,anio_const from bicicletas where anio_const >= 2019 order by nombre;
select 'Consulta 3';
select nom_fab from motocicletas_electricas where proveedor = (select prov_id from proveedor where prov_nombre = 'Auteco');
select 'Consulta 4';
select nombre from bicicletas where idbicicletas in(select bicicletaid from intencion_compra where cliente = 'lucky') union select nom_fab from motocicletas_electricas where idmotocicleta in(select motocicletaid from intencion_compra where cliente = 'lucky')order by nombre;
select 'Consulta 5';
select alias,nombre, apellidos from clientes where alias in(select cliente from intencion_compra where bicicletaid = (select idbicicletas from bicicletas where nombre = 'Yeti'));
select 'Consulta 6';
select count(nombre) from bicicletas where anio_const >= 2019;


select * from motocicletas_electricas;
